...
function NavigationMenuTrigger({
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      className={cn(
        "group inline-flex h-8 w-max items-center justify-center gap-1 rounded-none bg-background px-3 py-1 text-xs font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50",
        className,
      )}
      {...props}
    >
  ...
  return (
    <div className={cn("absolute top-full left-0 flex justify-center")}>
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "origin-top-center relative mt-1.5 h-auto w-auto overflow-hidden rounded-none bg-popover text-popover-foreground shadow-lg ring-1 ring-foreground/10 data-open:animate-in data-open:zoom-in-90 data-closed:animate-out data-closed:zoom-out-95",
          className,
        )}
        {...props}
      />
...
function NavigationMenuIndicator({
  ...
  return (
    <div
      ...
      className={cn(
        "top-full z-[1] flex h-1.5 items-end justify-center overflow-hidden data-open:animate-in data-open:fade-in data-closed:animate-out data-closed:fade-out",
        className,
      )}
      {...props}
    >
